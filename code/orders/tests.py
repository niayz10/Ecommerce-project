...
# from orders.repositories import OrderRepositoriesInterface, OrderRepositoriesV1


# class OrderTestCase(TestCase):
#     order_repos: OrderRepositoriesInterface = OrderRepositoriesV1()
...
#         self.assertEqual(self.order_repos.get_orders().count() == 1, 0, msg='Equal')